...
var examDetailPage = {
	...
	init: function (exam){
		...
		if (examDetailPage.data.exam.questions[0].questionType == 0) {
        ...
        } else if (examDetailPage.data.exam.questions[0].questionType == 1) {
	...
	targetQuestionAction: function(index){
        ...
        //记录答案
        if (examDetailPage.data.exam.questions[preIndex].questionType == 0) {
        ...
        } else if (examDetailPage.data.exam.questions[preIndex].questionType == 1) {
        	examDetailPage.data.exam.questions[preIndex].stuAnswer = '';
            $.each($("input[name='questionAnswer']:checked"),function(){
            	examDetailPage.data.exam.questions[preIndex].stuAnswer += $(this).val();
            });
        ...
        if (examDetailPage.data.exam.questions[index].questionType == 0) {
        ...
        } else if (examDetailPage.data.exam.questions[index].questionType == 1) {
